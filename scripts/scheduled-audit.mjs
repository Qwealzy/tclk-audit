...
const KNOWN_DEFECTS_BANNER = [
  ...
  '> file was written.',
  '>',
  '> - **Fixed on 2026-09-11: a refusal no longer hides the anomalies after it.** A refusal for any',
  '>   reason other than status is listed under Anomalies, and chains are kept per contract. One limit',
  '>   remains. A late copy of a frame that already applied can be counted below as a downstream',
  '>   consequence of an unrelated earlier refusal.',
